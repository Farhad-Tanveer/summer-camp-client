    ...
    <div>
      <footer className="footer flex justify-evenly p-10 bg-[#fcc044] text-base-content">
        ...
        <div>
          ...
          <a className="link link-hover">Office hours: 9:00am - 5:00pm</a>
          <a className="link link-hover">Telephone: 012-34-567</a>
          <a className="link link-hover">Email: info@email.com</a>
        </div>
      </footer>
